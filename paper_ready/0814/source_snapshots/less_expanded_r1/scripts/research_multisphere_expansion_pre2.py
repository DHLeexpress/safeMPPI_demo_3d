"""Run isolated PRE2 domain-randomized multi-sphere expansion.
...
use gamma-distinct randomized scenes, no route labels/guidance, uncertainty-
tilted K/B acquisition on every retry, and ordinary row-permutation replay.
"""
...
def main():
    ...
    if args.helios:
        status = run_expansion_on_helios(
            ...
            script_name="research_multisphere_expansion_pre2.py",
        )
