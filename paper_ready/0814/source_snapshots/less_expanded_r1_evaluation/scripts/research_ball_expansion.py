...
REPRODUCTION_COMMAND = "command.sh"
...
def main():
    ...
    parser.add_argument(
        "--learning-rate-final", type=float,
        help=(
    ...
    parser.add_argument(
        "--learning-rate-decay-steps", type=int,
        help=(
    ...
    parser.add_argument(
        "--flow-base-std-final", type=float, default=None,
        help=(
    ...
    parser.add_argument(
        "--fa-alloc-steps", type=int, default=3,
        help="RESEARCH: how many initial steps keep quadrant guidance in "
             "steps mode",
    )
    parser.add_argument(
        "--fa-alloc-band", type=float, default=0.25,
        help=(
    ...
    parser.add_argument(
        "--fa-alloc-map", type=str, default=None,
        help=(
    ...
    parser.add_argument(
        "--fa-alloc-band-below", type=float, default=None,
        help=(
    ...
    if args.helios:
        status = run_expansion_on_helios(
            ...
            script_name="research_ball_expansion.py",
        )
    ...
    def retry_progress(retry_row):
        ...
        print(
            ...
            f"{int(retry_row['max_retry_batches']) - 1} | "
    ...
    def _fa_hook(*, episode, step, gamma, round_i, eligible, queried,
        ...
        if step >= limit:
            return None
        quadrant = fa_map[int(episode["replica"]) % len(fa_map)]
